...
{
    /**
     * @var array<string, array<string,array<string,integer|string>|int|string>|int|string>
     */
    private $toot;
     ...
     *
     * @param array<string, array<string,array<string,integer|string>|int|string>|int|string> $toot
     */
